...
import com.rookievips.memojikeyboard.chunk.SmileysCategoryChunkAndroidStyle
 ...
 */
class SmileysCategoryAndroidStyle : EmojiCategory {
    override fun getEmojis(): Array<GoogleEmoji> {
        return SmileysCategoryChunkAndroidStyle.get()
    }
