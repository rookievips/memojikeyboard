...
import com.rookievips.memojikeyboard.chunk.FoodsDrinkCategoryChunkAndroidStyle
 ...
 */
class FoodsDrinkCategoryAndroidStyle : EmojiCategory {
    override fun getEmojis(): Array<GoogleEmoji> {
        return FoodsDrinkCategoryChunkAndroidStyle.get()
    }
